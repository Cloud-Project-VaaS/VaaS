...
# Load model and tokenizer once at cold start for better performance
SAVE_MODEL_PATH = "vinaykarman/robertabase"
...
def _predict_probabilities(text: str) -> Dict[str, float]:
    ...
    # Map indices to our canonical labels
    # Assumption: label_0 -> Bug, label_1 -> Enhancement, label_2 -> Question
    index_to_category = {
        0: "Bug",
        1: "Enhancement",
        2: "Question",
